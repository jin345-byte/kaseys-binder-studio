...
(function(){
  ...
  loadStyle('styles/binder-cover-designer.css?v=3.1.0','kbsBinderCoverDesignerStyle');
  ...
  loadScript('features/binder-cover-designer.js?v=3.1.0','kbsBinderCoverDesignerScript');
