...
(function(){
  ...
  loadStyle('styles/physical-binder-preview.css?v=3.2.0','kbsPhysicalBinderPreviewStyle');
  ...
  loadScript('features/physical-binder-preview.js?v=3.2.0','kbsPhysicalBinderPreviewScript');
