/* Kasey's Binder Studio v3.4.1 theme lab — full theme picker + persistence. */
(function(){
  ...
  function ensureThemeStyles(){
    ...
    ensureStylesheet('kbsThemeAnimatedAccentsStyle','styles/theme-animated-accents.css?v=3.4.1');
  }
  function readStored(){
