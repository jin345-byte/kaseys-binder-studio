/* Kasey's Binder Studio v4.0.6 — expanded typography picker. */
(function(){
  'use strict';
  const KEY='kbsFontChoice';
  const FONTS={
    system:{label:'System Sans',hint:'Cleanest default'},
    verdana:{label:'Verdana',hint:'Wide and highly readable'},
    trebuchet:{label:'Trebuchet',hint:'Friendly sans serif'},
    georgia:{label:'Georgia',hint:'Classic serif'},
    arial:{label:'Arial',hint:'Simple familiar sans serif'},
    helvetica:{label:'Helvetica',hint:'Clean modern neutral'},
    segoe:{label:'Segoe UI',hint:'Modern Windows interface'},
    tahoma:{label:'Tahoma',hint:'Compact and very readable'},
    calibri:{label:'Calibri',hint:'Soft contemporary sans serif'},
    candara:{label:'Candara',hint:'Rounded humanist sans serif'},
    century:{label:'Century Gothic',hint:'Geometric and spacious'},
    gill:{label:'Gill Sans',hint:'Classic humanist sans serif'},
    franklin:{label:'Franklin Gothic',hint:'Strong condensed display'},
    optima:{label:'Optima',hint:'Elegant flared sans serif'},
    arialrounded:{label:'Arial Rounded',hint:'Soft rounded interface'},
    garamond:{label:'Garamond',hint:'Elegant traditional serif'},
    palatino:{label:'Palatino',hint:'Warm book-style serif'},
    times:{label:'Times New Roman',hint:'Traditional editorial serif'},
    bookman:{label:'Bookman',hint:'Friendly heavy serif'},
    courier:{label:'Courier New',hint:'Classic typewriter mono'},
    consolas:{label:'Consolas',hint:'Clean modern monospace'},
    lucida:{label:'Lucida Console',hint:'Retro compact monospace'},
    impact:{label:'Impact',hint:'Bold condensed display'},
    comic:{label:'Comic Sans',hint:'Playful casual lettering'}
  };
